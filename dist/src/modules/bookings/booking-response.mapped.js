...
exports.mapTourBooking = mapTourBooking;
exports.mapAccommodationBooking = mapAccommodationBooking;
exports.mapTransferBooking = mapTransferBooking;
exports.mapRentalBooking = mapRentalBooking;
function mapTourBooking(booking) {
    return {
        id: booking.id,
...
function mapAccommodationBooking(booking) {
    return {
        id: booking.id,
        reference: booking.reference,
        type: booking.type,
...
async function mapTransferBooking(booking) {
    return {
        id: booking.id,
        reference: booking.reference,
        type: booking.type,
...
async function mapRentalBooking(booking) {
    return {
        id: booking.id,
        reference: booking.reference,
        type: booking.type,
